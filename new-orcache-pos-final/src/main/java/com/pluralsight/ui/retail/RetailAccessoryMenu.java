package com.pluralsight.ui.retail;

import com.pluralsight.model.option.RetailAccessory;
import com.pluralsight.model.option.RetailTier;
import com.pluralsight.model.retail.RetailAccessoryItem;
...
public class RetailAccessoryMenu {
	private ConsoleFormatter consoleFormatter = new ConsoleFormatter();
	private static final Scanner scanner = new Scanner(System.in);
	int WIDTH = 65;

	public void displayRetailAccessoryMenu(ArrayList<TransactionLineItem> currentOrderItems) {
		while (true) {
